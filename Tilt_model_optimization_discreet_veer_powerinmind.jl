...
function vel_deficit_plot(tilt, X_D, def_z, def_y, C_T, sigy, sigz, Vel_slice, alpha_in)
    ...
    wakesave3 = join([string("generated_DNN_7_5_slice_12.pdf")])
    wakesave4 = join([string("source_DNN_7_5_slice_12.pdf")])
    generated = npzread("generated_image_tilt_7.5_slice_12.0.npy")
    source = npzread("source_image_tilt_7.5_slice_12.0.npy")
    # generated = generated[end:-1:1, :]
    ...
    # find vel_deficit at each of the points
    data1 = heatmap(Y_scaled,Z_scaled[1:30], Vel_deficit_grid, c=:Blues, clim=(0.0, 1.75))
    plot(data1, colorbar_title=" \nVelocity Deficit (m/s)", right_margin=5Plots.mm, yticks=[-1, 0, 1 ,2],xticks=[-2, -1, 0, 1, 2],grid=:false, xlabel="y/D",yguidefontsize=fontsz,legendfontsize=fontsz,xguidefontsize=fontsz,xtickfontsize=fontsz,ytickfontsize=fontsz)
    plot!(annotations = ([-2.3], 0.85,text("z*", fontxlabel)))
    savefig(wakesave)

    data1 = heatmap(Y_scaled,Z_scaled[1:30], Vel_opt_grid, c=:Blues, clim=(0.0, 1.75))
    plot(data1, colorbar_title=" \nVelocity Deficit (m/s)", right_margin=5Plots.mm, yticks=[-1, 0, 1 ,2],xticks=[-2, -1, 0, 1, 2], grid=:false, xlabel="y/D",yguidefontsize=fontsz,legendfontsize=fontsz,xguidefontsize=fontsz,xtickfontsize=fontsz,ytickfontsize=fontsz)
    plot!(annotations = ([-2.3], 0.85,text("z*", fontxlabel)))
    savefig(wakesave1)

    data1 = heatmap(Y_scaled,Z_scaled[1:30],Vel_SOWFA_grid, c=:Blues, clim=(0.0, 1.75))
    plot(data1, colorbar_title=" \nVelocity Deficit (m/s)", right_margin=5Plots.mm, yticks=[-1, 0, 1 ,2],xticks=[-2, -1, 0, 1, 2], grid=:false, xlabel="y/D",yguidefontsize=fontsz,legendfontsize=fontsz,xguidefontsize=fontsz,xtickfontsize=fontsz,ytickfontsize=fontsz)
    plot!(annotations = ([-2.3], 0.85,text("z*", fontxlabel)))
    savefig(wakesave2)

    data1 = heatmap(Y_scaled,Z_scaled, generated*8.1, c=:Blues, clim=(0.0, 1.75))
    plot(data1, colorbar_title=" \nVelocity Deficit (m/s)", right_margin=5Plots.mm, yticks=[-1, 0, 1 ,2],xticks=[-2, -1, 0, 1, 2], grid=:false, xlabel="y/D",yguidefontsize=fontsz,legendfontsize=fontsz,xguidefontsize=fontsz,xtickfontsize=fontsz,ytickfontsize=fontsz)
    plot!(annotations = ([-2.3], 0.85,text("z*", fontxlabel)))
    savefig(wakesave3)

    data1 = heatmap(Y_scaled,Z_scaled, source*8.1, c=:Blues, clim=(0.0, 1.75))
    plot(data1, colorbar_title=" \nVelocity Deficit (m/s)", right_margin=5Plots.mm, yticks=[-1, 0, 1 ,2],xticks=[-2, -1, 0, 1, 2], grid=:false, xlabel="y/D",yguidefontsize=fontsz,legendfontsize=fontsz,xguidefontsize=fontsz,xtickfontsize=fontsz,ytickfontsize=fontsz)
    plot!(annotations = ([-2.3], 0.85,text("z*", fontxlabel)))
    savefig(wakesave4)
end
...
# fopt_detailed_original = load(file_detail, "f_detail")
# fopt_detailed = load(file_detail_original, "f_detail")
