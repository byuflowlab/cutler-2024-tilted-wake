...
function objective_vel_wrapper!(g, x, params)
    ...
    for i = 1:length(tilt_angles)
        ...
        delta_V_model = delta_V_pertilt(tilt_val, slices, CT_val[i], kz1, kz2, kz3, ky1, ky2, sigy01, sigz01, sigz02, sigz03, filename)
...
function objective_vel_wrapper_plot(x, params)
    ...
    for i = 1:length(tilt_angles)
        ...
        filename = filenames[i]
        # find delta V based on the model for all slices and tilt angles
        delta_V_pertilt_plot(tilt_val, slices, CT_val[i], kz1, kz2, kz3, ky1, ky2, sigy01, sigz01, sigz02, sigz03, filename)
...
function run_optimization_SNOPT()
    ...
    snopt_options = Dict(
        ...
        "Summary file" => "snopt-summary-tilt_variablect.out",
        "Print file" => "snopt-print-tilt_variablect.out")
    ...
    filename_opt = "optimal_solution_variablect.jld"
    fopt_optimal = 100000
    best = x0
    for i = 1:iterations
        print("iterations: ", i, "\n")
        if i == 2
            ...
            sigz02 = -0.014
            sigz03 = 0.0419
            x0 = @. xc*[CTA, CTB, CTC, CTη, CTb, kz1, kz2, kz3, ky1, ky2, sigy01, sigz01, sigz02, sigz03]
        end
        xopt, fopt, info, out = minimize(obj_func!, x0, ng, lx, ux, lg, ug, options)
...
# filename_opt = "optimal_solution_newc_testing.jld"
# file_detail =  "objective_best_opt.jld"
...
# plot(slices, fopt_detailed[1], label="2.5")
# plot!(slices, fopt_detailed[2], label="5.0")
# plot!(slices, fopt_detailed[3], label="7.5")
# plot!(slices, fopt_detailed[4], label="10.0")
# plot!(slices, fopt_detailed[5], label="12.5")
